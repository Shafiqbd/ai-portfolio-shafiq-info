...
const ITEM_CLASSES = "glass-card flex items-start gap-3 rounded-2xl p-4";
...
export async function Achievements() {
  ...
  return (
    <Section eyebrow="Excellence & Learning" title="Achievements & Certifications">
      <div className="shadow-glow relative overflow-hidden rounded-3xl border border-transparent p-6 [background:linear-gradient(var(--background-elevated),var(--background-elevated))_padding-box,var(--gradient-brand-soft)_border-box] sm:p-10">
        <div
          aria-hidden="true"
          className="bg-mesh animate-mesh-drift pointer-events-none absolute inset-0 opacity-40 blur-3xl"
        />
