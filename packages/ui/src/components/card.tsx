...
export interface CardProps extends HTMLAttributes<HTMLDivElement> {
  /** Adds twinkling star particles that brighten on hover. */
  sparkle?: boolean;
}

export const Card = forwardRef<HTMLDivElement, CardProps>(
  ({ className, sparkle, children, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "group relative rounded-card border border-transparent p-6 shadow-sm transition-all duration-300",
...
export const CardHeader = forwardRef<HTMLDivElement, HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn("relative mb-4 flex flex-col gap-1", className)} {...props} />
  ),
);
...
export const CardFooter = forwardRef<HTMLDivElement, HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn("relative mt-4 flex items-center gap-3", className)} {...props} />
  ),
);
